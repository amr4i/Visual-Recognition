...
matched = {}
for imgName in os.listdir("../train/vo5_extra_body_volumizing_shampoo"):
	# print imgName
	# img2 = cv2.imread('../train/pringles_bbq/N1_291.jpg',0) # trainImage
	img2 = cv2.imread("../train/vo5_extra_body_volumizing_shampoo/"+imgName, 0) # trainImage
	# print img2
